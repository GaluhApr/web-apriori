...
<header class="site-header container-fluid">
    <div class="top-header">
        <div class="logo col-md-12 col-sm-12">
            <h1><a href="index.php"><em>DATA MINING</em> APRIORI</a></h1>
            <span>OPTIMASI STOK BARANG DENGAN ANALISIS PENJUALAN MENGGUNAKAN METODE ASSOCIATION RULE MINING DI TOKO HANDARI
            </span>
        </div> <!-- /.logo -->
